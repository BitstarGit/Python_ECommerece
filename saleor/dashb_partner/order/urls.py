...
urlpatterns = [
    ...
    url(r"^list/$", views.order_list, name="orderslist"),
    ...
    url(r"^(?P<order_pk>\d+)/cancelorder/$", views.cancel_order1, name="order-cancel1"),
    url(
    ...
    url(
        r"^(?P<order_pk>\d+)/fulfillment/(?P<fulfillment_pk>\d+)/status/$",
        views.change_fulfillment_status,
        name="fulfillment-change-status",
    ),
    url(
        r"^(?P<order_pk>\d+)/fulfillment/(?P<fulfillment_pk>\d+)/date/$",
        views.change_fulfillment_date,
        name="fulfillment-change-date",
    ),
    url(
