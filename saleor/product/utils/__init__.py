...
def product_for_partner_homepage(partner_url):
    # pylint: disable=cyclic-import
    from ..models import Product
    products = Product.objects.filter(partner_products__partner__url_short=partner_url,
                                      partner_products__visible=True)
