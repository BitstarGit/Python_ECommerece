...
ALLOWED_CLIENT_HOSTS = get_list(
    os.environ.get("ALLOWED_CLIENT_HOSTS", "localhost,127.0.0.1,192.168.6.216")
)
...
ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,192.168.6.216"))
...
SMS_FROM = os.environ.get("SMS_FROM", "zdr-axc")

INSTANCE_NAME = os.environ.get("INSTANCE_NAME")

FACE_LINK = os.environ.get("FACE_LINK")
INST_LINK = os.environ.get("INST_LINK")