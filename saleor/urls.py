...
from .dashb_partner.urls import urlpatterns as partnerdashboard_urls
from .data_feeds.urls import urlpatterns as feed_urls
from .graphql.api import schema
from .graphql.views import GraphQLView
from .core.views import resolve_url
from .order.urls import urlpatterns as order_urls
from .page.urls import urlpatterns as page_urls
from .product.urls import urlpatterns as product_urls
from .search.urls import urlpatterns as search_urls
from .partner.admin import admin_site
...
non_translatable_urlpatterns = [
    ...
    url(r"^partner/", include((partnerdashboard_urls, "partner"), namespace="partner")),
...
urlpatterns += [
    ...
    url(r'^(?P<username>\w+)/$', resolve_url, name="resolve-url"),
]
